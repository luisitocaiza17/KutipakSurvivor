...
public class TipospalabrasRecord extends UpdatableRecordImpl<TipospalabrasRecord> implements Record4<Integer, String, String, String> {

	private static final long serialVersionUID = 259372366;
	...
	/**
	 * Setter for <code>kutipak.tipospalabras.CODIGOKTPAK</code>.
	 */
	public void setCodigoktpak(String value) {
		setValue(3, value);
	}

	/**
	 * Getter for <code>kutipak.tipospalabras.CODIGOKTPAK</code>.
	 */
	...
	public Field<String> field4() {
		return Tipospalabras.TIPOSPALABRAS.CODIGOKTPAK;
	}
	 ...
	 */
	@Override
	public TipospalabrasRecord value4(String value) {
		setCodigoktpak(value);
		return this;
	}
	 ...
	 */
	@Override
	public TipospalabrasRecord values(Integer value1, String value2, String value3, String value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TipospalabrasRecord(Integer tipoid, String nombretipo, String nemotecnico, String codigoktpak) {
		super(Tipospalabras.TIPOSPALABRAS);

		setValue(0, tipoid);
		setValue(1, nombretipo);
		setValue(2, nemotecnico);
		setValue(3, codigoktpak);
	}
}
